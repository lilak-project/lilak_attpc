#ifndef ATWAVELETNEW_H
#define ATWAVELETNEW_H
...
class ATWaveletNew {
public:
    ATWaveletNew(const std::vector<double>, int);
    ATWaveletNew(const std::vector<double>, int, bool);
    ATWaveletNew(const std::vector<double>, int, int, int);
    ATWaveletNew(const std::vector<double>, std::vector<double>);
    ATWaveletNew(const std::vector<double>, std::vector<double>, bool);
// Getters and Setters
public:
