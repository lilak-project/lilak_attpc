...
ATWaveletNew::ATWaveletNew(const std::vector<double> voltArray, int numWaveletsInput, bool Morlet) : startNumber(32), stopNumber(2048) {
    volt = voltArray;
    size = volt.size();
    numWavelets = numWaveletsInput;
...
ATWaveletNew::ATWaveletNew(const std::vector<double> voltArray, int numWaveletsInput, int start, int stop) {
    volt = voltArray;
    size = volt.size();
    numWavelets = numWaveletsInput;
    startNumber = start;
...
ATWaveletNew::ATWaveletNew(const std::vector<double> voltArray, std::vector<double> range) {
    volt = voltArray;
    size = volt.size();
...
ATWaveletNew::ATWaveletNew(const std::vector<double> voltArray, std::vector<double> range, bool Morlet) {
    volt = voltArray;
    size = volt.size();
...
void ATWaveletNew::MakeNumWavelets() {
    scale = linspace(startNumber, stopNumber, numWavelets);
}

double ATWaveletNew::Ricker(double f, double width, double length) {
...
std::pair<double, double> ATWaveletNew::Morlet(int n, double width, double length) {
...
std::vector<double> ATWaveletNew::linspace(double a, double b, int n) {
...
std::vector<double> ATWaveletNew::fftw_convolve(const std::vector<double> a, const std::vector<std::pair<double, double> > b) {
    size_t n_a = a.size();
    size_t n_b = b.size();
...
std::vector<std::vector<double> > ATWaveletNew::fftw_convolve_fast(const std::vector<double> a, const std::vector<std::vector<std::pair<double, double> > > b) {
    size_t n_a = a.size();
